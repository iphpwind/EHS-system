...
module.exports = {
  enable: function(instance) {
    ...
    zoomGroup.setAttribute('transform', 'translate(' + ( 10 ) + ' ' + ( 10 ) + ') scale(0.75)');
...
, _createZoomReset: function(instance){
    ...
    resetPanZoomControl.setAttribute('transform', 'translate(90 3) scale(0.4)');
...
, _createZoomOut: function(instance){
    ...
    zoomOut.setAttribute('transform', 'translate(60 5) scale(0.015)');
