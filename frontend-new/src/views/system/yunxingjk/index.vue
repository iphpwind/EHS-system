  ...
  <div class="jianshi">
      ...
      <div class="fangda">
		...
		<div class="main" :style="{ height: maniHt}">
			...
			<el-row :gutter="30" style="height: 78%;">
				<el-col :span="12">
				...
				<el-col :span="12">
					<div class="box rightbox">
						...
						<div style="height:calc(100% - 42px)" @mouseout='mouseout' @mouseover='mouseover'>
							<el-table id="table1" ref="table1" :data="sensorList" height="100%">
					...
					<div class="box rightbox">
						...
						<el-table id="table2" ref="table2" :data="ycList" height="calc(100% - 41px)">
							<el-table-column prop="areaName" label="区域" />
							<el-table-column prop="sensorName" label="设备名称" />
...
export default {
  ...
  mounted: function () {
    this.topimageLoaded();  //设置主界面高度
		...
		//打印当前页面放大倍数
		//console.log('1111',window.devicePixelRatio);
  ...
  methods: {
		tableScroll () {
			...
			//console.log('11111',scrolllength,divData.height)
      ...
      if (this.size == 'small') {
        ...
        document.querySelector('.navbar').style.display = 'block';
				if(window.devicePixelRatio == 1.5){
					...
					document.querySelector('.app-main').style.height = '';
				}
	...
	.main{
		...
		.alldata{
			...
			.dataitem{
				...
				.ico{
					display: block;margin: 0 auto;width: 50px;
				}
				h4{
		...
		.box{
			...
			.boxtit{
				...
				width: 100%;text-align: center;color: #fff;font-size: 16px;
				padding:8px 0 11px
			}
		}
		.box:before{
			content: '';width: 100%;height: 20px;
			...
			.btn{
				...
				:deep(.el-select) {
					...
					.el-input__inner{
						...
						border: 1px solid #019eff;color: #fff;
					}
				}
			}
		}
		.rightbox{
			...
			:deep(.el-table) {
				...
				th.el-table__cell{
					...
					color: #09ccde;font-weight: normal;font-size: 14px;
				}
				...
				td.el-table__cell{
					border: 0;color: #fff;padding: 5px 0;text-align: center;
				} 
