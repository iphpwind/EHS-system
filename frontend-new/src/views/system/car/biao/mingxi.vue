<template>
  <div class="app-container">
    ...
    <el-table height="calc(100vh - 300px)" :data="informationList">
      ...
      <!-- <el-table-column label="行车轨迹" prop="carModel" /> -->
      <el-table-column label="出车时间" prop="startTime" />
      <el-table-column label="收车时间" prop="endTime" />
      <el-table-column label="静止时间(分钟)" prop="restTime" />
      <el-table-column label="行驶时间(分钟)" prop="driveTime" />
      <el-table-column label="里程数(公里)" prop="mileage" />
...
import { list } from "@/api/car/report";
import {ref} from "vue";
