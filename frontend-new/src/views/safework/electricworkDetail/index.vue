<template>
  <div class="report">
    <div class="title"><span>临时用电作业详情</span>
    ...
    <el-collapse @change="handleChange">
      <el-collapse-item title="基础信息" name="1">
        <div class="earthitem">
          ...
          <table>
            ...
            <tr>
              <td>作业人：</td>
              <td colspan="2">
                <span v-for="(item,index) in form.safeOperationElectricworkUserList">
                  <img :src="item.sign" alt="" class="qianming">
                </span>
              </td>
            </tr>
        ...
        <div class="earthitem">
          <h4>现场确认</h4>
          <table>
            <tr v-for="(item,index) in form.safeOperationElectricworkSceneUserList">
        ...
        <div class="earthitem">
          <h4>作业审批</h4>
          <table>
            <tr v-for="item in form.safeOperationElectricworkApprovalList">
        ...
        <div class="earthitem">
          <h4>作业验收</h4>
          <table>
            <tr v-for="(item,index) in form.safeOperationElectricworkCheckList">
      ...
      <el-collapse-item title="分析化验" name="2">
        <div v-for="item in form.safeOperationElectricworkAnalysisList" class="earthitem">
          <table>
      ...
      <el-collapse-item title="现场确认" name="3">
        <div v-for="item in form.safeOperationElectricworkSceneUserList" class="earthitem">
          <h4>{{item.departmentName}}</h4>
          <div v-for="aa in item.safeOperationElectricworkSceneContentList" >
      ...
      <el-collapse-item title="作业审核" name="4">
        <div class="earthitem" v-for="item in form.safeOperationElectricworkApprovalList">
          <table>
            <tr>
              <td>{{item.operationName}}：</td>
      ...
      <el-collapse-item title="作业验收" name="5">
        <div class="earthitem" v-for="item in form.safeOperationElectricworkCheckList">
          <table>
            <tr>
              <td>{{item.checkName}}</td>
              <td colspan="2"></td>
...
export default {
  ...
  methods: {
    ...
    getRefuse(){
      listRefuse({operationType:'5',type:'0',mainId:this.id}).then(response => {
        if(response.rows.length>0){
          this.cancelform = response.rows[0];
        }
      })
      listRefuse({operationType:'5',type:'1',mainId:this.id}).then(response => {
