...
<!--      <el-col :span="1.5">
      ...
      <el-col :span="1.5">
        <el-button
            ...
            icon="Download"
            @click="handleExport"
            v-hasPermi="['safework:suppliesType:export']"
        >导出
        </el-button>
      </el-col>
...
import {listType, getType, delType, addType, updateType} from "@/api/safework/suppliestype";
import {h} from "vue";
