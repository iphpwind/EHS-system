...
<!--      <el-col :span="1.5">
    ...
    <el-table v-loading="loading" :data="targetUserExamineList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="人员" align="center" prop="typeName" />
    ...
    <el-dialog :title="title" v-model="open" width="800px" append-to-body>
      <el-form ref="targetUserExamineRef" :model="form" :rules="rules" label-width="120px">
        <el-form-item label="考核人姓名" prop="typeId">
        ...
        <el-form-item label="考核部门" prop="examineDeptId">
          <tree-select
              v-model:value="form.examineDeptId"
              :options="deptOptions"
              placeholder="请选择考核部门"
    ...
    <el-dialog title="查看安全考核管理" v-model="lookopen" width="800px" append-to-body>
      <el-form ref="targetUserExamineRef" :model="form" :rules="rules" label-width="120px" disabled>
        <el-form-item label="考核人姓名" prop="typeId">
          <el-input v-model="form.typeName" placeholder="请输入考核人" readonly @click="getStffList" style="width: 50%"/>
        </el-form-item>
        <el-table v-loading="loading" :data="subtableList" style="width: 100%" height="200">
    ...
    <el-dialog :title="staff.title" v-model="staff.open" width="50%" append-to-body>
      ...
      <el-table v-loading="loading" :data="staffList" @row-click="closeDetail1">
...
<script setup name="TargetUserExamine">
...
function closeDetail1(row){
  form.value.typeName=row.staffName;
  form.value.typeId=row.staffId;
  form.value.type = '1';
  staff.open = false;
};
...
function reset() {
  ...
  proxy.resetForm("targetUserExamineRef");
}
...
/** 提交按钮 */
function submitForm() {
  proxy.$refs["targetUserExamineRef"].validate(valid => {
    if (valid) {
...
function handleExport() {
  proxy.download('safework/targetUserExamine/export', {
    ...queryParams.value
  }, `targetUserExamine_${new Date().getTime()}.xlsx`)
}
