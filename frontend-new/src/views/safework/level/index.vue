<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="100px">
      <el-form-item label="管控层级编码" prop="levelCode">
        <el-input
      ...
      <el-form-item label="管控层级" prop="levelName">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['safework:level:edit']"
        >修改</el-button>
      </el-col>
<!--      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['safework:level:remove']"
        >删除</el-button>
      </el-col>-->
      <el-col :span="1.5">
        <el-button
          ...
          icon="Download"
          @click="handleExport"
          v-hasPermi="['safework:level:export']"
        >导出</el-button>
      </el-col>
      <right-toolbar v-model:showSearch="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table height="calc(100vh - 330px)"  v-loading="loading" :data="levelList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="管控层级编码" align="center" prop="levelCode" />
...
<!--          <el-button
    ...
    <!-- 添加或修改风险分析单元管控层级字典对话框 -->
    <el-dialog :title="title" v-model="open" width="600px" append-to-body>
      <el-form ref="levelRef" :model="form" :rules="rules" label-width="120px">
        <el-form-item label="管控层级编码" prop="levelCode">
          <el-input v-model="form.levelCode" placeholder="请输入管控层级编码" />
        </el-form-item>
        <el-form-item label="管控层级" prop="levelName">
          <el-input v-model="form.levelName" placeholder="请输入管控层级" />
        </el-form-item>
        <el-form-item label="层级" prop="level">
...
import { listLevel, getLevel, delLevel, addLevel, updateLevel } from "@/api/safework/level";
import {h} from "vue";
...
function handleExport() {
  proxy.download('safework/level/export', {
    ...queryParams.value
