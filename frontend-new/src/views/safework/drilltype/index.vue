...
<!--      <el-col :span="1.5">
        <el-button
            ...
            :disabled="multiple"
            @click="handleDelete"
            v-hasPermi="['safework:type:remove']"
        >删除
        </el-button>
      </el-col>-->
      <el-col :span="1.5">
        <el-button
            ...
            icon="Download"
            @click="handleExport"
            v-hasPermi="['safework:type:export']"
        >导出
        </el-button>
      </el-col>
...
import {listType, getType, delType, addType, updateType} from "@/api/safework/drilltype";
import {h} from "vue";
...
function handleExport() {
  proxy.download('safework/type/export', {
    ...queryParams.value
