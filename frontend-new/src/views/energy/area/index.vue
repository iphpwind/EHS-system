<template>
  <div class="app-container">
    ...
    >
      <el-table-column label="电力区域名称" align="center" prop="areaName"/>
    ...
    <el-dialog :title="title" v-model="open" width="600px" append-to-body>
      <el-form ref="areaRef" :model="form" :rules="rules" label-width="120px">
        <el-form-item label="父电力区域" prop="parentId">
          <tree-select
              v-model:value="form.parentId"
              :options="areaOptions"
              :objMap="{ value: 'id', label: 'areaName', children: 'children' }"
              value-key="id"
              placeholder="请选择父电力区域"
              check-strictly
          />
        </el-form-item>
        <el-form-item label="电力区域名称" prop="areaName">
          <el-input v-model="form.areaName" placeholder="请输入电力区域名称"/>
        </el-form-item>
...
import {listArea, getArea, delArea, addArea, updateArea,getFlag} from "@/api/energy/area";
