    ...
    <el-row :gutter="10" class="mb8 toolsline">
      <el-col :span="1.5">
        <el-button
            ...
            icon="Plus"
            @click="handleAdd"
            v-hasPermi="['industry:industryArea:add']"
        >新增
        </el-button>
      </el-col>
      <el-col :span="1.5">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button
              ...
              v-hasPermi="['industry:industryArea:edit']"
          >修改
          </el-button>
          <el-button
              type="text"
          ...
          <el-button
              ...
              v-hasPermi="['industry:industryArea:remove']"
          >删除
          </el-button>
        </template>
      </el-table-column>
...
import {listArea, getArea, delArea, addArea, updateArea,getFlag} from "@/api/industry/industryArea";
