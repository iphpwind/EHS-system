...
//获取当前日期、时间、周几
  ...
  methods: {
    ...
    startVedio(geturl) {
      push(geturl).then(res => {
        console.log(res)
        this.videoid = res.data
      })
      this.videourl = localStorage.videourl + 'record/' + this.newdate + '/' + this.newtime + '/' + this.newdate + '/out.m3u8';
    ...
    nhfx(dataArray, data) {
      ...
      myChart.setOption({
        ...
        series: [
          {
            // barWidth : 40,
            data: [130,120,150,145,172,148,119],
            type: 'bar',
            // showBackground: true,
            // backgroundStyle: {
            //   // 背景色
