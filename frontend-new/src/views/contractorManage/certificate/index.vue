  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="证件名称" prop="certificateName">
        <el-input v-model="queryParams.certificateName" placeholder="请输入证件名称" />
      </el-form-item>

      <el-form-item label="姓名" prop="personnelName">
        <el-input v-model="queryParams.personnelName" placeholder="请输入姓名" />
      </el-form-item>
      <el-form-item label="到期提醒" prop="expire">
        <el-select v-model="queryParams.expire" placeholder="到期提醒" clearable>
          <el-option
    ...
    <el-dialog :title="title" v-model="open" width="600px" append-to-body>
      <el-form ref="certificateRef" :model="form" :rules="rules" label-width="120px">
        ...
        <el-form-item label="发证机关" prop="certificateAgency">
          <el-input v-model="form.certificateAgency" placeholder="请输入发证机关" />
        </el-form-item>
...
import { listCertificate, getCertificate, delCertificate, addCertificate, updateCertificate } from "@/api/certificateManage/certificate";
...
const { certificate_personnel_type, status } = proxy.useDict('certificate_personnel_type', 'status');
...
function handleExport() {
  proxy.download('certificateManage/certificate/export', {
    ...queryParams.value
